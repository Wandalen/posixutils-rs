...
fn sort_test(args: &[&str], test_data: &str, expected_output: &str) {
    let str_args: Vec<String> = args.iter().map(|s| String::from(*s)).collect();
...
mod sort_tests {
    ...
    fn test_03d() {
        ...
        //sort_test(&["-k0", "-"], "", "", 2, "$prog: -: invalid field specification '0'\n");
    }

    #[test]
    fn test_03e() {
        // Fail with a diagnostic when -k specifies character == 0.
        //sort_test(&["-k1.0", "-"], "", "", 2, "$prog: character offset is zero: invalid field specification '1.0'\n");
    }
    ...
    fn test_08a() {
        ...
        //sort_test(&["-k", "2.,3", "-"], "", "", 2, "$prog: invalid number after '.': invalid count at start of ',3'\n");
    }

    #[test]
    fn test_08b() {
        // report an error for ',' without following POS2
        //sort_test(&["-k", "2,", "-"], "", "", 2, "$prog: invalid number after ',': invalid count at start of ''\n");
    }
